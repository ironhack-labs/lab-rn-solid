...
userUtils.saveToDatabase();
userUtils.sendWelcomeEmail();
...
const fileLogger: Logger = new FileLogger("This is a log message in a file.");
const databaseLogger: Logger = new DatabaseLogger("This is a log message in the database.");

fileLogger.log(); // Output: Logging to file: This is a log message in a file.
databaseLogger.log(); // Output: Logging to database: This is a log message in the database.